 ...
 */
public class Boxing {
    public static final String EXTRA_SELECTED_MEDIA = "com.kanade.imageselector_core.Boxing.selected_media";
    public static final String EXTRA_ALBUM_ID = "com.kanade.imageselector_core.Boxing.album_id";

    static final String EXTRA_CONFIG = "com.kanade.imageselector_core.Boxing.config";
    static final String EXTRA_RESULT = "com.kanade.imageselector_core.Boxing.result";
    static final String EXTRA_START_POS = "com.kanade.imageselector_core.Boxing.start_pos";
    ...
    public interface OnBoxingFinishListener {
        ...
        /**
         * live with {@link com.kanade.imageselector_core.presenter.PickerContract.View#onFinish(List)}
         *
