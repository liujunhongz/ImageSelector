...
import com.kanade.imageselector_core.loader.IBoxingCallback;
 ...
 * @author ChenSL
 */
public abstract class AbsBoxingViewActivity extends AppCompatActivity implements com.kanade.imageselector_core.presenter.PickerContract.View {
    ArrayList<com.kanade.imageselector_core.model.entity.BaseMedia> mSelectedImages;
    String mAlbumId;
    int mStartPos;

    private com.kanade.imageselector_core.presenter.PickerContract.Presenter mPresenter;
     ...
     */
    @Override
    public void showMedia(@Nullable List<com.kanade.imageselector_core.model.entity.BaseMedia> medias, int allCount) {
    }

    @Override
    public void showAlbum(@Nullable List<com.kanade.imageselector_core.model.entity.AlbumEntity> albums) {
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            config = savedInstanceState.getParcelable(com.kanade.imageselector_core.Boxing.EXTRA_CONFIG);
        } else {
    ...
    private void parseSelectedMedias(Bundle savedInstanceState, Intent intent) {
        if (savedInstanceState != null) {
            mSelectedImages = savedInstanceState.getParcelableArrayList(com.kanade.imageselector_core.Boxing.EXTRA_SELECTED_MEDIA);
            mAlbumId = savedInstanceState.getString(com.kanade.imageselector_core.Boxing.EXTRA_ALBUM_ID);
            mStartPos = savedInstanceState.getInt(com.kanade.imageselector_core.Boxing.EXTRA_START_POS, 0);
        } else if (intent != null) {
            mStartPos = intent.getIntExtra(com.kanade.imageselector_core.Boxing.EXTRA_START_POS, 0);
            mSelectedImages = intent.getParcelableArrayListExtra(com.kanade.imageselector_core.Boxing.EXTRA_SELECTED_MEDIA);
            mAlbumId = intent.getStringExtra(com.kanade.imageselector_core.Boxing.EXTRA_ALBUM_ID);
        }
    }
    ...
    public final void loadRawImage(@NonNull ImageView img, @NonNull String path, IBoxingCallback callback) {
        com.kanade.imageselector_core.BoxingMediaLoader.getInstance().displayRaw(img, path, callback);
    }
    ...
    public void onFinish(@NonNull List<BaseMedia> medias) {
        ...
        intent.putParcelableArrayListExtra(com.kanade.imageselector_core.Boxing.EXTRA_RESULT, (ArrayList<BaseMedia>) medias);
    }
    ...
    public void onSaveInstanceState(Bundle outState, PersistableBundle outPersistentState) {
        ...
        outState.putParcelable(com.kanade.imageselector_core.Boxing.EXTRA_CONFIG, BoxingManager.getInstance().getBoxingConfig());
    }
