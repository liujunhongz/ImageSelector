...
import com.kanade.imageselector_core.model.BoxingBuilderConfig;
import com.kanade.imageselector_core.model.BoxingManager;
import com.kanade.imageselector_core.model.config.BoxingConfig;
import com.kanade.imageselector_core.model.config.BoxingCropOption;
...
import com.kanade.imageselector_core.utils.CameraPickerHelper;
...
public abstract class AbsBoxingViewFragment extends Fragment implements PickerContract.View {
    ...
    /**
     * start camera to take a photo or recording.
     *
